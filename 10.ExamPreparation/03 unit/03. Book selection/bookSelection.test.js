...
const bookSelection = require(`./bookSelection`);
  ...
  describe(`bookSelection tests`, function() {
    describe('isGenreSuitable', function() {
      ...
      it('with non-Thriller and non-Horror Genre, should return that the books are suitable', function() {
        //Arrange
    ...
    describe('isItAffordable', function() {
      ...
      it('with less budget then price, should return correct result', function() {
        let price = 31;
        let budget = 30;
        let price2 = 32.3;
        let budget2 = 23.3
