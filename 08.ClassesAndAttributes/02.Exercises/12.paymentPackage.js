...
describe("tests for PaymentPackage", () => {
  describe("Tests for the Name", () => {
    ...
    it("throw new Error if the Name is number", () => {
  ...
  describe("Tests for the toString method", () => {
    ...
    it("if input is correct and Vat is set to 30 return string", () => {
        const instance = new PaymentPackage("abc", 123);
        instance.VAT = 30;
        const output = [
            `Package: abc`,
    ...
    it("if input is correct and Active is set to false return string", () => {
        const instance = new PaymentPackage("abc", 123);
